...
$ticker_col_class  = " col-sm-10 col-md-11 col-lg-12 pr-0 pl-0";
...
if($xpanel["header-clock-box"] && $xpanel["header-islamic-date"] == 0) {
    $dt_col_class = " col-sm-2 col-md-2 col-lg-2 pl-0 pr-0";
    $ticker_col_class  = " col-sm-14 col-md-14 col-lg-14 pr-0 pl-0";
}
?>
...
<div class="nav-wrap wrap-at-top">
    <nav class="main-menu-v3 mb-0" id="main-nav">
...
<!-- Header Top -->
<div class="header-top v2 row ml-0 mr-0">

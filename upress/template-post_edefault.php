...
<div id="primary" class="content-area pt-10 mt-10">
	...
	<div id="main" class="col-lg-11 col-md-10 col-sm-10 col-xs-16 pull-left english-post-view post-view" role="main">
		<div class="container-fluid">
            
			<div class="<?php echo $content_class ?> col-md-16 col-sm-16 col-xs-16 post-view-content pl-0">
				<?php while ( have_posts() ) : the_post(); ?>
					<?php setViews(''.$ip_address.'',''.get_the_ID().''); ?>
					<?php get_template_part( 'template-parts/content', 'singleEnglish' ); ?>

				<?php endwhile; // End of the loop. ?>
			</div>
            <div class="mini-sidebar-single <?php echo $sidebar_class ?> hidden-md hidden-sm hidden-xs pr-0">

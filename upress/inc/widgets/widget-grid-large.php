...
*/
add_action( 'widgets_init', 'grid_block_large_posts_widget' );
 
function grid_block_large_posts_widget() {
    register_widget( 'upress_grid_block_large_widget' );
}
 
class upress_grid_block_large_widget extends WP_Widget
{
 
    public function __construct()
    {
        $widget_details = array(
            'classname' => 'upress_grid_block_large_widget',
            'description' => 'Grid Block For Displaying Posts from a Specific Category',
            'panels_groups' => array('urdupress')
        );
 
        parent::__construct( 'upress_grid_block_large_widget', 'UPRESS - Grid Block (Wide)', $widget_details );
...
<div class="posts-blocks">
    ...
    if ( $posts_query->have_posts() ) {
        while ( $posts_query->have_posts() ) {
            ...
            <div class="block-post-grid-wide col-lg-4 col-md-4 col-sm-8 col-xs-16 mb-20">
            	<div class="grid-wide-inner">

...
*/
add_action( 'widgets_init', 'classic_block_posts_widget' );
 
function classic_block_posts_widget() {
    register_widget( 'upress_classic_block_widget' );
}
 
class upress_classic_block_widget extends WP_Widget
{
 
    public function __construct()
    {
        $widget_details = array(
            'classname' => 'upress_classic_block_widget',
            'description' => 'Classic Block For Displaying Posts from a Specific Category',
            'panels_groups' => array('urdupress')
        );
 
        parent::__construct( 'upress_classic_block_widget', 'UPRESS - Classic Block', $widget_details );
    ...
    <div class="posts-blocks">
        ...
        <div class="block-head row ml-0 mr-0" style="background:<?php echo $bgcolor; ?>">
            ...
            <span class="section-more-btn">
                <a href="<?php echo esc_url( get_category_link( $catid ) ); ?>">
                    ...
                    <span class="more-icon"><i class="fa fa-chevron-left"></i></span>
                </a>
            </span>
        </div>
        <div class="block-body classic-block">
        <?php
        $i = 1;
        $args = array(
            'cat' => $catid,
        ...
        if ( $posts_query->have_posts() ) {
            while ( $posts_query->have_posts() ) {
                ...
                <?php if($i == 1) { ?>
                <div class="mb-10 pt-10 block-post-first pull-right">
                ...
                <?php } else { ?>
                <div class="pb-5 mb-10 block-post-smallrow">
                    <div class="post-content">

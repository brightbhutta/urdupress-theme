...
*/
add_action( 'widgets_init', 'modern_block_posts_widget' );
 
function modern_block_posts_widget() {
    register_widget( 'upress_modern_block_widget' );
}
 
class upress_modern_block_widget extends WP_Widget
{
 
    public function __construct()
    {
        $widget_details = array(
            'classname' => 'upress_modern_block_widget',
            'description' => 'Modern Block For Displaying Posts from a Specific Category',
            'panels_groups' => array('urdupress')
        );
 
        parent::__construct( 'upress_modern_block_widget', 'UPRESS - Modern Block', $widget_details );

...
*/
add_action( 'widgets_init', 'grid_block_posts_widget' );
 
function grid_block_posts_widget() {
    register_widget( 'upress_grid_block_widget' );
}
 
class upress_grid_block_widget extends WP_Widget
{
 
    public function __construct()
    {
        $widget_details = array(
            'classname' => 'upress_grid_block_widget',
            'description' => 'Grid Block For Displaying Posts from a Specific Category',
            'panels_groups' => array('urdupress')
        );
 
        parent::__construct( 'upress_grid_block_widget', 'UPRESS - Grid Block', $widget_details );

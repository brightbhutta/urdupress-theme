...
*/
add_action( 'widgets_init', 'modern_block_v2_posts_widget' );
 
function modern_block_v2_posts_widget() {
    register_widget( 'upress_modern_block_v2_widget' );
}
 
class upress_modern_block_v2_widget extends WP_Widget
{
 
    public function __construct()
    {
        $widget_details = array(
            'classname' => 'upress_modern_block_v2_widget',
            'description' => 'Modern Block For Displaying Posts from a Specific Category',
            'panels_groups' => array('urdupress')
        );
 
        parent::__construct( 'upress_modern_block_v2_widget', 'UPRESS - Modern Block (v2)', $widget_details );
...
<div class="posts-blocks">
    ...
    if ( $posts_query->have_posts() ) {
        while ( $posts_query->have_posts() ) {
            ...
            <div class="pb-5 mb-10 block-post-smallrow noborder col-lg-16 col-md-16 col-sm-16 col-xs-16 pl-0 pr-0">
                <div class="post-content">

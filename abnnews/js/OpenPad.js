...
UrduPhonetic.Keys['l']=new Key(0x0644, 0x0628);
...
/*UrduPhonetic.Keys['0']=new Key(0x0030, charCode(')'));
UrduPhonetic.Keys['1']=new Key(0x0031, charCode('!'));
UrduPhonetic.Keys['2']=new Key(0x0032, charCode('@'));
UrduPhonetic.Keys['3']=new Key(0x0033, charCode('#'));
UrduPhonetic.Keys['4']=new Key(0x0034, charCode('$'));
UrduPhonetic.Keys['5']=new Key(0x0035, charCode('%'));
UrduPhonetic.Keys['6']=new Key(0x0036, charCode('^'));
UrduPhonetic.Keys['7']=new Key(0x0037, charCode('&'));
UrduPhonetic.Keys['8']=new Key(0x0038, charCode('*'));
UrduPhonetic.Keys['9']=new Key(0x0039, charCode('('));*/
...
//UrduPhonetic.Keys['.']=new Key(0x06D4);
...
function setEnglish(sName)
{
    langArray[sName]=0;
    var	el=document.getElementById(sName);
    el.style.backgroundColor="#EFEFFB";
...
function makeUrduEditor(idx, pt)
{
    ...
    with(el.style)
    {
        fontFamily="Urdu Naskh Asiatype, Tahoma";
        fontSize=pt;
...
{
    if(rows>1)
    document.writeln('<TEXTAREA	NAME="'+sName+'" id="'+sName+'"	ROWS="'+rows+'"	COLS="'+cols+'"	style="font-family:Urdu Naskh Asiatype, Tahoma; font-size:'+pt+';	background-color: #FFFF99 "	lang="ur" dir="rtl"	wrap="soft"	onkeypress="processKeypresses()" onclick="storeCaret(this)"	onkeyup="storeCaret(this)" onFocus=	"setEditor(this)"></TEXTAREA>');
    else
    document.writeln('<input type="text" name="'+sName+'" id="'+sName+'" size="'+cols+'" style="font-family:Urdu Naskh Asiatype, Tahoma; font-size:'+pt+'; background-color: #FFFF99"	lang="ur" dir="rtl"	onkeypress="processKeypresses()" onclick="storeCaret(this)"	onkeyup="storeCaret(this)" onfocus="setEditor(this)">');
    var	el=document.getElementById(sName);
    langArray[sName]=1;
    el.lang="ur";
    el.dir="rtl";
...
function initUrduEditor(cssPath)
{
    ...
    document.writeln('<style type="text/css">@import"wp-content/themes/upress/css/OpenPad.css";</style>');
}